...
import pytest
import psutil
from hpsim.netinfo import InterfaceInfo, get_interface_info, _default_gateway
...
class TestGetInterfaceInfo:
    ...
    def test_get_interface_info_basic(self, mock_net_if_addrs):
        ...
        with patch("hpsim.netinfo._default_gateway", return_value="192.168.1.1"):
    ...
    def test_get_interface_info_no_gateway(self, mock_net_if_addrs):
        ...
        with patch("hpsim.netinfo._default_gateway", return_value=None):
            info = get_interface_info("eth0")
...
class TestDefaultGateway:
    ...
    def test_default_gateway_with_mock(self):
        ...
        try:
            ...
            from hpsim.netinfo import _default_gateway as gateway_func
